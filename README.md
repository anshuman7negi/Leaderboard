...
2. Type your name and score in the input field. Click the "submit" button or press the "Enter" key to add the name and score to the list.
3. Click on the refresh button to refresh the table and get your name and score in the list.
5. Uses Rest API to store and receive the data.
6. To use the API we need a special key that is generated by the createGame function in the api.js file.
7. To store and receive the data from the API we used the fetch() method.
